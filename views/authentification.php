    ...
    <header>
        ...
        <div id="container">
            ...
            <form action="../controllers/cconnexion.php" method="POST">
               ...
               <input type="text" placeholder="Entrer l'Identifiant" name="username" required style="outline: none;">
                <label><b>Mot de passe</b></label>
                <input type="password" placeholder="Entrer le mot de passe" name="password" required style="outline: none;">
                <?php
                ...
                ?>
                <input type="submit" id='submit' value='Connexion' style="outline: none;">
                <?php
                if(isset($_GET['erreur'])){
                    $err = $_GET['erreur'];
                    if($err == 'idError') {
                        echo "<p style='color:rgb(202, 198, 198)'> <a href=\"motdepasseoublie.php\"><u> Mot de passe oublié?</u></a> </p>";
                    }
                }
                ?>
