...
@keyframes sideAnime {
    ...
    <!-- Title Page-->
    <title>inscription Agitel</title>

    <!-- Icons font CSS-->
    
</head>

<body style="background:url(assets/img/agitel2.png);background-repeat: no-repeat;background-size: cover;" >
    <header>
    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading" style="background: #2e856c;">
                ...
                <div class="card-body">
                    <form method="POST" action="../controllers/cinscription.php" enctype="multipart/form-data" id="form">
                        ...
                        <div class="form-row m-b-55">
                            <div class="name">Telephone etudiant </div>
                            <div class="value">
